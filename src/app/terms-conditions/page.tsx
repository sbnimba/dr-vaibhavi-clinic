      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none text-sm leading-relaxed text-gray-600">
            <p>These Terms & Conditions govern your access to and use of the Dr. Vaibhavi Clinic website. By accessing or using this website to book appointments or read content, you agree to be bound by these Terms & Conditions.</p>
